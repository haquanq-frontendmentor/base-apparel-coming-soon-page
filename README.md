...
<p>
  <a href="https://www.frontendmentor.io/solutions/responsive-coming-soon-page-w-html---css-flexbox---js-DOLlqm9sIj">
    <img
      alt="Solution post"
      src="https://img.shields.io/badge/Frontendmentor-blue?label=Solution%20on"
    /></a>
  <a href="https://haquanq-frontendmentor.github.io/base-apparel-coming-soon-page/">
    <img
      alt="Live demo"
...
- [x] Subscription form that provides hint on input error
...
```
git clone https://github.com/haquanq-frontendmentor/base-apparel-coming-soon-page.git
```
